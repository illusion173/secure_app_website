...
'''
# Ensure cryptography layer is imported for this function!
# Function should only be called by mobile application
...
def lambda_handler(event, context):
    # User sends their encrypted and signed session data 
    ...
    response = table.update_item(
        ...
        }, #sorry for this terrible naming convention
        UpdateExpression="set #session_jwt_token=:r, set #session_session_status=:q",
        ExpressionAttributeNames={
            '#session_jwt_token': 'jwt_token',
            '#session_session_status' : 'session_status'
        },
    ...
    # Tell the user authentication was attempted
    return {
            'statusCode' : 200
        }
