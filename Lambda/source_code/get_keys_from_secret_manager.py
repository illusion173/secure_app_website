...
'''
Called by mobile application to get system public keys.

Public keys can be sent in clear text

Future implementation could be encrypting with the user's public key to ensure confidentiality
'''
def get_secret():
