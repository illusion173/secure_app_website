...
# ensure that the cryptography layer is inputted for this function
def lambda_handler(event, context):
    ...
    # actual creation of session id, converts to a bytes 
    ...
    # Since this function will be called by the website, return the signed and unsigned session id 
    return {
